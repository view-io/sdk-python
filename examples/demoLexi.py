...
def readSourceDocumentStatistics():
    statistics = lexi.SourceDocument.retrieve_statistics("00000000-0000-0000-0000-000000000000", "00000000-0000-0000-0000-000000000000")
    print(statistics)

# readSourceDocumentStatistics()

def readTopTerms():
    terms = lexi.SourceDocument.retrieve_top_terms("00000000-0000-0000-0000-000000000000", "00000000-0000-0000-0000-000000000000")
    print(terms)

# readTopTerms()

def readSourceDocument():
    document = lexi.SourceDocument.retrieve("00000000-0000-0000-0000-000000000000", "00000000-0000-0000-0000-000000000000",True)
    print(document)
...
def searchCollection():
    search = lexi.Collection.search("79bedb07-6408-4841-987c-3bb4b0e6ffd8", 
        emit_results=True,
        MaxResults= 2,
        Skip= 1,
        ContinuationToken= "",
...
def readCollectionStatistics():
    statistics = lexi.Collection.retrieve_statistics("79bedb07-6408-4841-987c-3bb4b0e6ffd8")
    print(statistics)
...
def enumerateCollectionDocuments():
    documents = lexi.Collection.enumerate_documents("79bedb07-6408-4841-987c-3bb4b0e6ffd8",{
            "MaxResults": 100,
            "Skip": 0,   
