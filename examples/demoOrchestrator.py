...
def readPerformanceData():
    performanceData = orchestration.DataFlow.retrieve_request_log_file("321cea16-7b64-4038-899a-ea3a82b0b457","00000000-0000-0000-0000-000000000000")
    print(performanceData)

# readPerformanceData()

def readDataFlow():
    dataflow = orchestration.DataFlow.retrieve("321cea16-7b64-4038-899a-ea3a82b0b457",True)
    print(dataflow)
...
def readStep():
    step = orchestration.Step.retrieve("cf731a32-9581-4583-8bd2-50267b036352",incl_data=True,incl_subordinates=True)
    print(step)
...
def updateTrigger():
    trigger = orchestration.Trigger.update("8fc742a5-9ef7-4304-8ea4-2fba6b755f92", 
        TriggerType="HTTP",
