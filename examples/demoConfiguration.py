...
def readObjectLock():
    objectLock = configuration.ObjectLock.retrieve("00000000-0000-0000-0000-000000000000")
    print(objectLock)
...
def deleteWebhookRule():
    webhookRule = configuration.WebhookRule.delete("0664fc21-9ece-4be2-9ee4-6ddb8624621d")
    print(webhookRule)

# deleteWebhookRule()

def existsWebhookRule():
    webhookRule = configuration.WebhookRule.exists("0664fc21-9ece-4be2-9ee4-6ddb8624621d")
    print(webhookRule)

# existsWebhookRule()   

def updateWebhookRule():
    webhookRule = configuration.WebhookRule.update("0664fc21-9ece-4be2-9ee4-6ddb8624621d",
...
def readWebhookRule():
    webhookRule = configuration.WebhookRule.retrieve("0664fc21-9ece-4be2-9ee4-6ddb8624621d")
    print(webhookRule)
...
def deleteWebhookTarget():
    webhookTarget = configuration.WebhookTarget.delete("e6509b81-dc3c-44e3-ab16-16e907fb03ef")
    print(webhookTarget)

# deleteWebhookTarget() 

def existsWebhookTarget():
    webhookTarget = configuration.WebhookTarget.exists("e6509b81-dc3c-44e3-ab16-16e907fb03ef")
    print(webhookTarget)

# existsWebhookTarget()

def updateWebhookTarget():
    webhookTarget = configuration.WebhookTarget.update("e6509b81-dc3c-44e3-ab16-16e907fb03ef",
...
def readWebhookTarget():
    webhookTarget = configuration.WebhookTarget.retrieve("e6509b81-dc3c-44e3-ab16-16e907fb03ef")
    print(webhookTarget)
...
def existsWebhookEvent():
    webhookEvent = configuration.WebhookEvent.exists("00000000-0000-0000-0000-000000000000")
    print(webhookEvent)
...
def readWebhookEvent():
    webhookEvent = configuration.WebhookEvent.retrieve("00000000-0000-0000-0000-000000000000")
    print(webhookEvent)
...
def deleteEncryptionKey():
    encryptionKey = configuration.EncryptionKey.delete("ee70aa3b-b00f-4459-95e1-4683a4404b08")
    print(encryptionKey)

# deleteEncryptionKey()

def existsEncryptionKey():
    encryptionKey = configuration.EncryptionKey.exists("ee70aa3b-b00f-4459-95e1-4683a4404b08")
    print(encryptionKey)

# existsEncryptionKey()

def updateEncryptionKey():
    encryptionKey = configuration.EncryptionKey.update("ee70aa3b-b00f-4459-95e1-4683a4404b08",
...
def readEncryptionKey():
    encryptionKey = configuration.EncryptionKey.retrieve("ee70aa3b-b00f-4459-95e1-4683a4404b08")
    print(encryptionKey)
...
def deleteEncryptionKey():
    graphRepository = configuration.EncryptionKey.delete("626c44ef-cdc5-450f-8760-e6b863624cd8")
    print(graphRepository)

# deleteGraphRepository()

def existsGraphRepository():
    graphRepository = configuration.GraphRepository.exists("626c44ef-cdc5-450f-8760-e6b863624cd8")
    print(graphRepository)
...
def readGraphRepository():
    graphRepository = configuration.GraphRepository.retrieve("626c44ef-cdc5-450f-8760-e6b863624cd8")
    print(graphRepository)
...
def deleteGraphRepository():
    graphRepository = configuration.GraphRepository.delete("2fd4c223-34f9-4150-a5fb-ce1ccbe36762")
    print(graphRepository)

# deleteVectorRepository()

def updateVectorRepository():
    vectorRepository = configuration.VectorRepository.update("2fd4c223-34f9-4150-a5fb-ce1ccbe36762",
...
def existsVectorRepository():
    vectorRepository = configuration.VectorRepository.exists("2fd4c223-34f9-4150-a5fb-ce1ccbe36762")
    print(vectorRepository)
...
def readVectorRepository():
    vectorRepository = configuration.VectorRepository.retrieve("2fd4c223-34f9-4150-a5fb-ce1ccbe36762")
    print(vectorRepository)
...
def deleteEmbeddingsRules():
    embeddingsRules = configuration.EmbeddingsRule.delete("51050c21-1640-43c4-bd1f-0e4748eca602")
    print(embeddingsRules)

# deleteEmbeddingsRules()

def existsEmbeddingsRules():
    embeddingsRules = configuration.EmbeddingsRule.exists("51050c21-1640-43c4-bd1f-0e4748eca602")
    print(embeddingsRules)

# existsEmbeddingsRules()

def updateEmbeddingsRules():
    embeddingsRules = configuration.EmbeddingsRule.update("51050c21-1640-43c4-bd1f-0e4748eca602",
...
def readEmbeddingsRules():
    embeddingsRules = configuration.EmbeddingsRule.retrieve("51050c21-1640-43c4-bd1f-0e4748eca602")
    print(embeddingsRules)
...
def deleteMetaDataRules():
    metaDataRules = configuration.MetadataRule.delete("7cbdd486-5cf6-415c-b504-436ce2b6eb44")
    print(metaDataRules)

# deleteMetaDataRules() 

def existsMetaDataRules():
    metaDataRules = configuration.MetadataRule.exists("7cbdd486-5cf6-415c-b504-436ce2b6eb44")
    print(metaDataRules)

# existsMetaDataRules()

def updateMetaDataRules():
    metaDataRules = configuration.MetadataRule.update("7cbdd486-5cf6-415c-b504-436ce2b6eb44",
         BucketGUID="00000000-0000-0000-0000-000000000000",
...
def readMetaDataRules():
    metaDataRules = configuration.MetadataRule.retrieve("7cbdd486-5cf6-415c-b504-436ce2b6eb44")
    print(metaDataRules)
...
def readCredential():
    credential = configuration.Credential.retrieve("a0589510-c808-417c-aea8-6bf3c35179a4")
    print(credential)
...
def updateUser():
    user = configuration.User.update("b40e2df1-4a6c-4263-94db-9e9459fffd6c",
...
def deleteNode():
    node = configuration.Node.delete("784141bc-9717-4d0e-8079-1db6782baec6",headers={"x-token":""})
    print(node)

# deleteNode()

def checkNode():
    node = configuration.Node.exists("784141bc-9717-4d0e-8079-1db6782baec6",headers={"x-token":""})
    print(node)

# checkNode()

def retrieveNode():
    node = configuration.Node.retrieve("784141bc-9717-4d0e-8079-1db6782baec6",headers={"x-token":""})
    print(node)

# retrieveNode()

def enumerateNodes():
    nodes = configuration.Node.enumerate(headers={"x-token":""})
    print(nodes)

# enumerateNodes()

def retrieveAllNodes():
    nodes = configuration.Node.retrieve_all(headers={"x-token":""})
    print(nodes)    
...
def deleteTenant():
    tenant = configuration.Tenant.delete("b7d0a699-52a3-4d97-b24e-d15b9bd066f4",headers={"x-token":""})
    print(tenant)

# deleteTenant()

def existTenant():
    tenant = configuration.Tenant.exists("b7d0a699-52a3-4d97-b24e-d15b9bd066f4",headers={"x-token":""})
    print(tenant)

# existTenant()

def updateTenant():
    tenant = configuration.Tenant.update("b7d0a699-52a3-4d97-b24e-d15b9bd066f4",headers={"x-token":""},
   data={
...
def readTenant():
    tenant = configuration.Tenant.retrieve("b7d0a699-52a3-4d97-b24e-d15b9bd066f4",headers={"x-token":""})
    print(tenant)

# readTenant()

def enumerateTenants():
    tenants = configuration.Tenant.enumerate( headers={"x-token":""})
    print(tenants)
...
def getAdministratorToken():
    token = configuration.Authentication.retrieve_administrator_token( email="admin@view.io",password="viewadmin")
    print(token)

# getAdministratorToken()

def getAuthenticationTokenSha256():
    token = configuration.Authentication.generate_authentication_token_sha_256("default@user.com","e75255193871e245472533552fe45dfda25768d26e9eb92507e75263e90c6a4","00000000-0000-0000-0000-0000000000000")
    print(token)
...
def getAuthenticationToken():
    token = configuration.Authentication.generate_authentication_token("default@user.com","password","00000000-0000-0000-0000-0000000000000")
    print(token)
