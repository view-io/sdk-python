...
def chat_config():
    result = assistant.Assistant.chat_config("5ba8908d-947b-470e-83aa-57874b5d2d80",
...
def appendChatThread():
    result = assistant.ChatThread.append("7e0d729f-6253-4757-82eb-4793c6f95af8",
       role= "assistant",
...
def updateConfig():
    updateConfig = assistant.Config.update("c625f9b6-e482-4958-be1f-7e644a524bb5",
