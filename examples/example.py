...
graph = litegraph_sdk.Graph.retrieve_all()
print(graph)
...
# all_repos = view_sdk.orchestration.Trigger.retrieve_all()
# print(f"Found {len(all_repos)} data repositories")
# print(f"First repository: {all_repos[0].guid}")
