...
class TestOpenAI:
    def test_validate_connectivity_success(self):
        ...
        with patch('view_sdk.resources.vector.openai.get_client', return_value=mock_client) as mock_get_client:
    ...
    def test_generate_embeddings_success(self):
        ...
        with patch('view_sdk.resources.vector.openai.get_client', return_value=mock_client):
            with patch('view_sdk.resources.vector.openai.EmbeddingsGeneratorMixin.create') as mock_create:
