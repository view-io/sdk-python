...
def test_embeddings_rule_minimal_creation():
    ...
    assert rule.embeddings_generator_url == "http://localhost:8000/v1.0/tenants/default/embeddings"
    assert rule.embeddings_generator_api_key == "default"
    assert rule.processing_endpoint == "http://localhost:8000/v1.0/tenants/default/processing"
