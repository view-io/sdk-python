...
def test_graph_repository_minimal_creation():
    ...
    repo = GraphRepositoryModel(tenant_guid="12345678-1234-5678-1234-567812345678")
...
def test_invalid_port_range():
    ...
    with pytest.raises(ValidationError) as exc_info:
        GraphRepositoryModel(
            tenant_guid="12345678-1234-5678-1234-567812345678", port=-1
        )
    ...
    with pytest.raises(ValidationError) as exc_info:
        GraphRepositoryModel(
            tenant_guid="12345678-1234-5678-1234-567812345678", port=65536
        )
    assert "port" in str(exc_info.value)
...
def test_custom_created_utc():
    ...
    repo = GraphRepositoryModel(
        tenant_guid="12345678-1234-5678-1234-567812345678", created_utc=custom_date
    )
...
def test_populate_by_name():
    ...
    repo1 = GraphRepositoryModel(
        tenant_guid="12345678-1234-5678-1234-567812345678", name="Test Repo 1"
    )
