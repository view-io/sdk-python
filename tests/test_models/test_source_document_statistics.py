...
class TestSourceDocumentStatisticsModel:
    ...
    def test_terms_with_udr_no_terms(self, mock_source_document, mock_udr_document_empty):
    ...
    def test_distinct_terms_with_terms(self, mock_source_document, mock_udr_document_with_terms):
    ...
    def test_key_value_pairs_no_schema(self, mock_source_document, mock_udr_document_empty):
        """Test key-value pairs count with UDR but no schema."""
        mock_source_document.udr_document = mock_udr_document_empty
        stats = SourceDocumentStatisticsModel(source_document=mock_source_document)
        assert stats.key_value_pairs == 0

    def test_key_value_pairs_with_schema(self, mock_source_document, mock_udr_document_empty, mock_schema_with_flattened):
    ...
    def test_semantic_cells_no_cells(self, mock_source_document, mock_udr_document_empty):
        """Test semantic cells count with UDR but no cells."""
        mock_source_document.udr_document = mock_udr_document_empty
        stats = SourceDocumentStatisticsModel(source_document=mock_source_document)
        assert stats.semantic_cells == 0

    def test_semantic_cells_with_cells(self, mock_source_document, mock_udr_document_empty, mock_semantic_cell):
    ...
    def test_semantic_cells_nested(self, mock_source_document, mock_udr_document_empty, mock_nested_semantic_cells):
    ...
    def test_semantic_cell_bytes_with_cells(self, mock_source_document, mock_udr_document_empty):
    ...
    def test_semantic_chunks_with_chunks(self, mock_source_document, mock_udr_document_empty, mock_semantic_cell):
    ...
    def test_semantic_chunks_nested(self, mock_source_document, mock_udr_document_empty, mock_nested_semantic_cells):
    ...
    def test_semantic_chunk_bytes_with_chunks(self, mock_source_document, mock_udr_document_empty, mock_nested_semantic_cells):
    ...
    def test_count_semantic_cells_helper_nested(self, mock_source_document, mock_nested_semantic_cells):
    ...
    def test_count_semantic_chunks_helper_nested(self, mock_source_document, mock_nested_semantic_cells):
    ...
    def test_sum_semantic_chunk_bytes_helper_nested(self, mock_source_document, mock_nested_semantic_cells):
        """Test _sum_semantic_chunk_bytes helper with nested structure."""
        stats = SourceDocumentStatisticsModel(source_document=mock_source_document)
        assert stats._sum_semantic_chunk_bytes(mock_nested_semantic_cells) == 16  # 8 + 8
    ...
    def test_comprehensive_integration(self, mock_source_document):
        ...
        assert stats.key_value_pairs == 3
        assert stats.semantic_cells == 2  # parent + child
        assert stats.semantic_cell_bytes == 40  # parent(8 + child's 16) + child(16) = 40
