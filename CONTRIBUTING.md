...
Welcome to `viewio_sdk` contributor's guide.
...
If you experience bugs or general issues with `viewio_sdk`, please have a look
...
You can help improve `viewio_sdk` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`viewio_sdk` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `viewio_sdk`'s files. While this mechanism can
...
```
conda create -n viewio_sdk python=3 six virtualenv pytest pytest-cov
conda activate viewio_sdk
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/viewio_sdk_python.git
   cd viewio_sdk_python
   ```
...
5. Install [pre-commit]:
   ...
   `viewio_sdk` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/viewio_sdk
[issue tracker]: https://github.com/<USERNAME>/viewio_sdk/issues
