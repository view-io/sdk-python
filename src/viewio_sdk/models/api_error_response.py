...
class ApiErrorResponse(BaseModel):
    ...
    context: StrictStr | None = Field(default=None, alias="Context")
    description: StrictStr | None = Field(default=None, alias="Description")
    __properties: ClassVar[list[str]] = ["Error", "Context", "Description"]
