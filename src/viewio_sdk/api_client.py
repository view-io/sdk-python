...
import viewio_sdk.models
from viewio_sdk import rest
from viewio_sdk.api_response import ApiResponse
from viewio_sdk.api_response import T as ApiResponseT
from viewio_sdk.configuration import Configuration
from viewio_sdk.exceptions import ApiException, ApiValueError
...
class ApiClient:
    ...
    ) -> ApiResponse[ApiResponseT] | bool:
        """Deserializes response into an object.

        :param response_data: RESTResponse object to be deserialized.
        :param response_types_map: dict of response types.
        :param status_only: When True, returns True/False based on the status code.
        :return: ApiResponse or boolean based on status_only.
        """

        # For status-only responses (like HEAD)
        if status_only:
            return 200 <= response_data.status <= 299
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(viewio_sdk.models, klass)
